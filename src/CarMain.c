...
/* camera variables*/
uint16_t line[128];			// current array of raw camera data
uint16_t filterLine[128];	// camera data filtered by smoothing
...
// [ ] figure out what direction the center of the track is
...
int main(void){
	...
	// TODO write and call initialization function for camera
