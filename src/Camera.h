...
// 3k worked last camera anle
// slightly elevated camera 2.4k
#define CONSERVATIVE_VCM	(2400) // this 5k works nicely - will keep as cons.
#define NORMAL_VCM		(2400)	
#define RECKLESS_VCM	(1500) // TODO test and tune
