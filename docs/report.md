...
*PID Controller Block Diagram*[^pidDiagram^]
...
*Line-Scan Camera Timing Diagram*[^cameraTiming^]
...
*Wiring Diagram for Line-Scan Camera*[^labManual^]
...
*Raw and Filtered Line-Scan Camera Data*[^ex5^]
...
*Race Day Track Configuration With Failure Points Marked*[^HarrisonTrackPhoto^]
